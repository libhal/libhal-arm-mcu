...
void setup_channel(int p_channel, timer_reg* p_reg)
{
...
void setup_enable_register(int p_channel, timer_reg* p_reg)
{
...
public:
                  ...
                  u32 p_pulses_per_rotation)
  {
    ...
    auto* timer_register = timer_reg::from(m_reg);
