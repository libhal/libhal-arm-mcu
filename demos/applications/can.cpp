...
void application(resource_list& p_map)
{
  ...
  auto& can_transceiver = resource_contract_assert(p_map.can_transceiver);
  auto& can_bus_manager = resource_contract_assert(p_map.can_bus_manager);
  auto& can_interrupt = resource_contract_assert(p_map.can_interrupt);
