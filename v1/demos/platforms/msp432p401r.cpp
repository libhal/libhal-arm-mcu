...
class msp432p401r_watchdog : public custom::watchdog
{
public:
  void start() override
  {
...
{
  return hal::v5::make_strong_ptr<msp432p401r_watchdog>(driver_allocator());
}

[[noreturn]] void terminate_handler() noexcept
{
  // No clock or status LED support is implemented for this platform yet, so
  // there is no way to signal a terminate condition. Spin here until a
...
void initialize_platform()
{
  ...
  // TODO: configure the msp432p401r clock tree once platform support for
  // this MCU is implemented.
}
