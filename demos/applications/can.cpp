...
void application(resource_list& p_map)
{
  ...
  while (true) {
    ...
    hal::can_message missed_message = standard_message;
    // This message has an ID that
    missed_message.extended(true).id(0x0222'0025);
    ...
    can_transceiver.send(missed_message);
    ...
    hal::print(console, "Printing received messages...\n");
