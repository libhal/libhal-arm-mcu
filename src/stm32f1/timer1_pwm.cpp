...
[[nodiscard]] peripheral get_peripheral_id(timer1_pwm::pwm_pins p_pin)
{
  ...
  } else if (p_pin == timer1_pwm::pwm_pins::pa0 ||
             p_pin == timer1_pwm::pwm_pins::pa1 ||
             p_pin == timer1_pwm::pwm_pins::pa2 ||
             p_pin == timer1_pwm::pwm_pins::pa3) {
    return peripheral::timer2;
  } else if (p_pin == timer1_pwm::pwm_pins::pa6 ||
             p_pin == timer1_pwm::pwm_pins::pa7 ||
             p_pin == timer1_pwm::pwm_pins::pb0 ||
             p_pin == timer1_pwm::pwm_pins::pb1) {
    return peripheral::timer3;
  } else if (p_pin == timer1_pwm::pwm_pins::pb6 ||
             p_pin == timer1_pwm::pwm_pins::pb7 ||
             p_pin == timer1_pwm::pwm_pins::pb8 ||
             p_pin == timer1_pwm::pwm_pins::pb9) {
...
void setup(timer1_pwm::pwm_pins p_pin)
{
  ...
  if (p_pin == timer1_pwm::pwm_pins::pa8 ||
      p_pin == timer1_pwm::pwm_pins::pa0 ||
      p_pin == timer1_pwm::pwm_pins::pa6 ||
      p_pin == timer1_pwm::pwm_pins::pb6) {  // channel 1 for timer1,2,3,4
    ...
    setup_channel(reg, 1, peripheral_id);
             ...
             p_pin == timer1_pwm::pwm_pins::pa1 ||
             p_pin == timer1_pwm::pwm_pins::pa7 ||
             p_pin == timer1_pwm::pwm_pins::pb7) {  // channel 2
    bit_modify(reg->capture_compare_mode_register)
    ...
    setup_channel(reg, 2, peripheral_id);
             ...
             p_pin == timer1_pwm::pwm_pins::pa2 ||
             p_pin == timer1_pwm::pwm_pins::pb0 ||
             p_pin == timer1_pwm::pwm_pins::pb8) {  // channel 3
    ...
    setup_channel(reg, 3, peripheral_id);
             ...
             p_pin == timer1_pwm::pwm_pins::pa3 ||
             p_pin == timer1_pwm::pwm_pins::pb1 ||
             p_pin == timer1_pwm::pwm_pins::pb9) {  // channel 4
    bit_modify(reg->capture_compare_mode_register_2)
      .insert<output_compare_even>(pwm_mode_1)
      .insert<channel_output_select_even>(set_output)
